    ...
    try {
      ...
      for (const [name, details] of Object.entries(activities)) {
        ...
        activityCard.innerHTML = `
          ...
          <p><strong>Total Participants:</strong> <span class="participant-count">${details.participants.length}</span></p>
          <p><strong>Participants:</strong></p>
          <ul>${participants.map(participant => `<li>${participant}</li>`).join('')}</ul>
        `;
